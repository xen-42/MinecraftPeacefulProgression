...
public class GhastlingEntityRenderer extends MobEntityRenderer<GhastlingEntity, GhastlingEntityModel> {
    ...
    @Override
    public Identifier getTexture(GhastlingEntity entity) {
